...
// Since User model is missing, we'll modify the controller to work without it
...
const requestLoginOTP = async (req, res) => {
    try {
        ...
        // Skip user verification since User model is missing
        // In a production environment, you would want to verify the user exists
        ...
        await OTP.updateMany(
            { userId: new mongoose.Types.ObjectId(userId), purpose: "login", isVerified: false },
        ...
        const otpRecord = new OTP({
            ...
            email,
            otp,
            purpose: "login", // Add the purpose field
            expiresAt,
            attempts: 0,
            isVerified: false
        });
